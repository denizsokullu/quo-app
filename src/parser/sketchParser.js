...
class AbstractComponent {
  ...
  initChildren(data){
    ...
    data.layers.map( component => {
      //only add the artboards
      if(this.is('page') && component._class === 'artboard'){
        let abstractChild = new AbstractComponent(component);
        //add the reference to the children
        this.children.push(abstractChild);
      }
      // add everything else as children for other components
      else{
        let abstractChild = new AbstractComponent(component);
        //add the reference to the children
        this.children.push(abstractChild);
